...
We use the `t.test()` function with the argument `paired = TRUE`. Make sure the data are sorted by ID when you read them into R. The $df$ equals the number of participants minus 1.
