...
3, and it was precisely: Mean of means = `r round(mean(Sample.Means),2)`. *Remember, you would never know the true population mean. Good luck getting every rider of the CTA to answer a survey, and the Probability Gods only love me anyway, cause you have not spent your career tricking undergrads into a volcano.*
