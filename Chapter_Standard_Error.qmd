...
- $S_M$ = `r round(SEM1, 2)`,
- So our 95% confidence guess (i.e., $\pm2$ SE) would be `r round(M1-2*SEM1,2)` to `r round(M1+2*SEM1,2)`
...
- $S_M$ = `r round(SEM2, 2)`,
- So our 95% confidence guess (i.e., $\pm2$ SE) would be `r round(M2-2*SEM2,2)` to `r round(M2+2*SEM2,2)`
