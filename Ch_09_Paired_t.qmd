...
That is where [mixed regression](Ch_18_Mixed_Regression.qmd) begins. It keeps the repeated observations, tells the model which rows belong to the same human, and allows people to differ without creating one indicator variable for every person who wandered into the study.
