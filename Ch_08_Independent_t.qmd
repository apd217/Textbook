...
The [power chapter](Ch_07_Power_Effect_Size.qmd) did all of this for the one-sample test. The function is the same, and exactly one argument changes: `type = "two.sample"`.
...
If you measured the **same people twice**, the groups are not independent and this test is the wrong tool. Continue to the [paired-samples *t*-test chapter](Ch_09_Paired_t.qmd), where the fact that Rider 12 appears in both columns stops being a problem and starts being the whole point.
