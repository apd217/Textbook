...
In [Multiple Regression: Statistical Control](Ch_13_Multiple_Regression.qmd), we predicted **Exam Score** from **Study Hours** and **Test Anxiety**. Study Hours and Anxiety were related to one another, which meant their relationships with Exam Score overlapped.
