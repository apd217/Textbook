...
We use one engine throughout the mixed chapters. For Gaussian outcomes, `glmmTMB` fits linear mixed models. By changing `family`, the same framework handles binary, count, negative-binomial, beta, and zero-inflated outcomes [@brooks2017].
