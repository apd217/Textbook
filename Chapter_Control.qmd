...
In the previous chapter, [Multiple Regression: Statistical Control](Chapter_Multiple_Regression_Control.qmd), we predicted **Exam Score** from **Study Hours** and **Test Anxiety**. Study Hours and Anxiety were related to one another, which meant their relationships with Exam Score overlapped.
