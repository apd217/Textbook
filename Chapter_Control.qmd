...
#| fig-alt: "Three overlapping circles. Study Hours sits upper left in blue, Test Anxiety upper right in orange, and Exam Score below and between them in green. Region a is where Study Hours overlaps Exam Score alone, region b is where Test Anxiety overlaps Exam Score alone, region c is where all three overlap, and region e is the part of the Exam Score circle no predictor touches."
...
#| fig-alt: "Scatterplot of Test Anxiety on the x axis against Study Hours on the y axis, with a downward-sloping orange regression line through a loose blue cloud of 100 students. Twelve purple vertical segments connect the most extreme points to the line, showing how far each of those students studied above or below what their anxiety score predicted."
...
#| fig-alt: "Two scatterplots side by side, each with an orange upward-sloping fit line. The left plot puts raw Study Hours on the x axis against Exam Score. The right plot replaces the x axis with the Study Hours residual after Anxiety is removed, while the y axis stays the original Exam Score. The right cloud is centred on zero and its slope is visibly shallower."
...
#| fig-alt: "Two scatterplots side by side, both with the Study Hours residual on the x axis and an orange fit line. The left plot keeps the original Exam Score on the y axis and is labelled with the semi-partial correlation. The right plot uses the Exam Score residual instead and is labelled with the larger partial correlation. Both point clouds tilt the same way; the right one is more tightly gathered around its line because the anxiety-related spread has been taken out of the y axis too."
...
<!-- ---Alex--- CH14-P01. Verified by running: slopes all 1.4149; standard errors 0.3693
     (full), 0.4056 (semi-partial route), 0.3674 (partial route); residual df 97 versus 98
     and 98. So the shortcut regressions really are one df richer than they have earned. -->
...
::: {.callout-important title="Control Does Not Manufacture Causality"}
