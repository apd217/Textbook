...
# The truth: a population with variance of exactly 25.
truth <- 25

# Take 10,000 small samples and estimate the variance both ways.
estimates <- replicate(10000, {
  s <- rnorm(8, mean = 100, sd = 5)
  deviations <- (s - mean(s))^2
  c(divide_by_N   = sum(deviations) / 8,
    divide_by_N_1 = sum(deviations) / 7)
})
