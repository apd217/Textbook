...
```{r monty-tree}
#| echo: false
#| fig-cap: "Every possible game, assuming you picked Door 1. Switching wins in two branches out of three."
#| fig-alt: "A tree diagram starting from a box reading you pick Door 1. It splits into three equally likely branches for where the car is: Door 1, Door 2, and Door 3. Under each branch a box shows what Monty must open and what switching gets you. Switching loses only in the branch where the car was behind Door 1, and wins in the other two, which are shaded."
#| fig-width: 8.5
#| fig-height: 5.0
par(mar = c(0, 0, 0, 0))
plot.new()
plot.window(xlim = c(0, 10), ylim = c(0, 6.4))
...
win_fill  <- adjustcolor("#009E73", alpha.f = 0.30)
lose_fill <- adjustcolor("#D55E00", alpha.f = 0.30)
plain_fill <- "#EAF4FA"

# Level 1: your choice
box(5, 5.6, "You pick Door 1", fill = "white", w = 2.0)

# Level 2: where the car actually is, each 1/3
box(1.7, 3.5, "Car behind\nDoor 1  (1/3)", fill = plain_fill, w = 1.5)
box(5.0, 3.5, "Car behind\nDoor 2  (1/3)", fill = plain_fill, w = 1.5)
box(8.3, 3.5, "Car behind\nDoor 3  (1/3)", fill = plain_fill, w = 1.5)

# Level 3: what Monty is forced to do, and what switching gets you
box(1.7, 1.2, "Monty opens\n2 or 3\nSWITCH = goat", fill = lose_fill, w = 1.5, h = 0.80)
box(5.0, 1.2, "Monty MUST\nopen 3\nSWITCH = car", fill = win_fill, w = 1.5, h = 0.80)
box(8.3, 1.2, "Monty MUST\nopen 2\nSWITCH = car", fill = win_fill, w = 1.5, h = 0.80)

arrows(4.2, 4.95, 2.4, 4.15, length = 0.10, lwd = 2, col = "#1F4E79")
arrows(5.0, 4.95, 5.0, 4.15, length = 0.10, lwd = 2, col = "#1F4E79")
arrows(5.8, 4.95, 7.6, 4.15, length = 0.10, lwd = 2, col = "#1F4E79")

arrows(1.7, 2.85, 1.7, 2.03, length = 0.10, lwd = 2, col = "#1F4E79")
arrows(5.0, 2.85, 5.0, 2.03, length = 0.10, lwd = 2, col = "#1F4E79")
arrows(8.3, 2.85, 8.3, 2.03, length = 0.10, lwd = 2, col = "#1F4E79")

text(5, 0.12,
     "Switching wins in 2 of the 3 equally likely branches.  Staying wins in 1.",
     cex = 0.92, font = 2, col = "#00614A")
```
