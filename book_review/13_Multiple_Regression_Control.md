# Chapter 13 — Multiple Regression: Statistical Control (Ch_13_Multiple_Regression.qmd)
...
- **Effort:** S
- **Location:** Ch_13_Multiple_Regression.qmd → "The Study Hours Slope — Before and After Controlling" (search anchor: "The controlled slope is more precise")
...
- **Perspective:** Student
- **Effort:** S
- **Location:** Ch_13_Multiple_Regression.qmd → end (search anchor: "No new imaginary undergraduates will be recruited")
...
- **Perspective:** Student
- **Effort:** S
- **Location:** Ch_13_Multiple_Regression.qmd → visualization chunks (search anchor: "plot_model(")
...
- **Perspective:** Professor
- **Effort:** S
- **Location:** Ch_13_Multiple_Regression.qmd → "Breaking Down the Venn Diagram Numerically" (search anchor: "region_c <- r2_model1 + r2_model2 - r2_model3")
...
- **Effort:** S
- **Location:** Ch_13_Multiple_Regression.qmd → "Visualizing Multiple Regression" (search anchor: "plot study before")
...
- **Perspective:** Publisher
- **Effort:** S
- **Location:** Ch_13_Multiple_Regression.qmd → "Making a Prediction" (search anchor: "predicted <- B0 + B1 * 10 + B2 * 45")
