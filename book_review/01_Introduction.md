# Chapter 1 — Why You Have to Learn Statistics (Chapter_Introduction.qmd)
...
- **Perspective:** Student
- **Effort:** S
- **Location:** Chapter_Introduction.qmd → "Measurement: Numbers Are Not Magic" (search anchor: "Michell distinguishes two jobs.")
...
- **Perspective:** Student
- **Effort:** M
- **Location:** Chapter_Introduction.qmd → "This Still Affects Your Life in a Serious Way" (search anchor: "In preclinical cancer biology, researchers repeated 50 experiments")
...
- **Perspective:** Student
- **Effort:** S
- **Location:** Chapter_Introduction.qmd → "Research Design: The Extremely Short Version" (search anchor: "Here are the terms you need before the rest of the book starts moving:")
...
- **Perspective:** Student
- **Effort:** M
- **Location:** Chapter_Introduction.qmd → "Research Design: The Extremely Short Version" (search anchor: "The basic research sequence is:")
...
- **Effort:** S
- **Location:** Chapter_Introduction.qmd → "Why Should You Care?" (search anchor: "That definition is deliberately incomplete.")
...
- **Approved:** [ X] — IMPLEMENTED 2026-08-12 (links to Chapter_OneSample_t_test.qmd). NOTE: the payoff half is still owed — CH06-P02 must add the formal p-value definition there and flag it as the IOU. Do not close that item without it.

### [CH01-P02] Kuhn/feedback-systems section: good, but one sentence overclaims
- **Priority:** LOW
- **Perspective:** Professor
- **Effort:** S
- **Location:** Chapter_Introduction.qmd → "Paradigms and the Stories We Tell About Causes" (search anchor: "Asking \"Which came first?\" can be a stupid question")
...
- **Perspective:** Professor
- **Effort:** S
- **Location:** Chapter_Introduction.qmd → callout "A Warning about Soft Theories" (search anchor: "Meehl argued that theories in")
...
- **Effort:** S
- **Location:** Chapter_Introduction.qmd → YAML front matter, lines 2–10 (search anchor: "fontsize: 11pt")
...
- **Perspective:** Publisher
- **Effort:** M
- **Location:** Chapter_Introduction.qmd → all three figure chunks (search anchor: "#| fig-cap: \"A real effect can produce wildly different estimates")
...
- **Perspective:** Publisher
- **Effort:** S
- **Location:** Chapter_Introduction.qmd → "Why Should You Care?" (search anchor: "Statistics does four jobs for us:")
