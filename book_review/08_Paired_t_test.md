# Chapter 8 — Paired-Samples t-Test (Ch_09_Paired_t.qmd)
...
- **Effort:** M
- **Location:** Ch_09_Paired_t.qmd → "A Chocolate-Fixation Study" (search anchor: "We measure 48 students twice:")
...
- **Perspective:** Student + Professor
- **Effort:** S
- **Location:** Ch_09_Paired_t.qmd → "Why Pairing Can Help" (search anchor: "This often gives a smaller standard error than an independent-samples analysis.")
...
- **Effort:** S
- **Location:** Ch_09_Paired_t.qmd → "Why Pair the Scores?" (search anchor: "matched strangers are not magical clones")
