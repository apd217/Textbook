# Chapter 17 — Categorical-by-Categorical Interactions: The 2×2 (Ch_17_Categorical_Interaction.qmd)
...
- **Effort:** S
- **Location:** Ch_17_Categorical_Interaction.qmd → "The Data" (search anchor: "we focus on the **extremes of the niceness distribution**")
...
- **Effort:** S
- **Location:** Ch_17_Categorical_Interaction.qmd → throughout (search anchors: "Predicted New Friends", "more friends than their equally disagreeable counterparts", "M_Friends")
...
- **Perspective:** Professor
- **Effort:** S
- **Location:** Ch_17_Categorical_Interaction.qmd → "The Data" (search anchor: "this unequal cell size is handled automatically")
...
- **Effort:** M
- **Location:** Ch_17_Categorical_Interaction.qmd → "Comparison" section (search anchor: "maps directly onto the two-way factorial ANOVA framework")
...
- **Perspective:** Student
- **Effort:** S
- **Location:** Ch_17_Categorical_Interaction.qmd → end (search anchor: "you have described two results but have not tested an interaction.")
...
colon, comma, or full stop depending on what the second half was doing. `Ch_04_Distributions`
