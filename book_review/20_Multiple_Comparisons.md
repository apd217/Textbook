# Chapter 20 — P-Values and Multiple Comparisons (Ch_20_Multiple_Comparisons.qmd)
...
- **Effort:** M
- **Location:** Ch_20_Multiple_Comparisons.qmd → after "Multiple Comparisons in Regression" (search anchor: "use software that can adjust the contrast family explicitly")
...
- **Approved:** [ x] — IMPLEMENTED 2026-08-17 as `## Where You Will Actually Meet This: emmeans`.
  **Used FOUR groups, not three, and that is the point.** `Chapter_Regression with Cat
  ...
  `](Ch_12_Categorical_Regression.qmd)`. Verified that Quarto resolves it to
  `./Ch_12_Categorical_Regression.html`, byte-identical to its own sidebar nav href.
...
- **Effort:** S
- **Location:** Ch_20_Multiple_Comparisons.qmd → "Multiple Comparisons in Regression" (search anchor: "# Example after fitting a model called model:")
...
- **Perspective:** Student
- **Effort:** S
- **Location:** Ch_20_Multiple_Comparisons.qmd → end (search anchor: "perform social cognition without preregistration.")
