# Chapter 2 — R: The Extremely Short Survival Guide (Ch_02_R_Basics.qmd)
...
- **Perspective:** Student
- **Effort:** M
- **Location:** Ch_02_R_Basics.qmd → after "Data Frames: Where the Undergraduates Are Stored" (search anchor: "The Institutional Review Board remains stubborn about this.")
...
- **Approved:** [ X] — IMPLEMENTED 2026-08-12 (~330 words; `read.csv` shown eval=FALSE, then live `head`/`str`/`factor`/`table` on the existing `study` frame so students see real output)

### [CH02-U02] No RStudio screenshot in the chapter that introduces RStudio
- **Priority:** HIGH
- **Perspective:** Student + Publisher
- **Effort:** M
- **Location:** Ch_02_R_Basics.qmd → "R Is Not RStudio" (search anchor: "Think of R as a temperamental but extremely capable chef.")
...
- **Approved:** [X ] — IMPLEMENTED 2026-08-12 (Alex supplied `RstudioScreenShot.png` mid-session; caption written from the actual image — dark theme, empty Environment, Packages tab showing — so caption and alt text match what is really on screen)

### [CH02-U03] Nowhere does the book teach `?function` — the single highest-value survival skill
- **Priority:** MED
- **Perspective:** Student
- **Effort:** S
- **Location:** Ch_02_R_Basics.qmd → "Errors Are Information, Delivered Rudely" (search anchor: "Ask for help and show the code")
...
- **Approved:** [X ] — IMPLEMENTED 2026-08-12 (own `## Asking R for Help` section before the errors section; closes on the chatbot-invented-function warning)

### [CH02-U04] No "Short Story" recap
- **Priority:** MED
- **Perspective:** Student
- **Effort:** S
- **Location:** Ch_02_R_Basics.qmd → end of file (search anchor: "The thinking remains your job.")
...
- **Approved:** [X ] — IMPLEMENTED 2026-08-12 (7 bullets; "R will calculate nonsense..." kept as the final line, per the item)

### [CH02-U05] Mention the Posit Cloud fallback
- **Priority:** LOW
- **Perspective:** Student
- **Effort:** S
- **Location:** Ch_02_R_Basics.qmd → "Install Them in This Order" (search anchor: "Give yourself time to install software.")
...
- **Approved:** [ X] — IMPLEMENTED 2026-08-12 (two sentences, links posit.cloud, placed right after the install-time warning)

### [CH02-P01] Operator-precedence hand-wave is fine, but one trap deserves a sentence: unary minus
- **Priority:** LOW
- **Perspective:** Professor
- **Effort:** S
- **Location:** Ch_02_R_Basics.qmd → "PEMDAS Has Returned" (search anchor: "Operations at the same level are generally handled in their defined order.")
...
- **Approved:** [X ] — IMPLEMENTED 2026-08-12 (both `-2^2` and `(-2)^2` in the chunk; forward pointer to squaring deviations added)

### [CH02-B01] Chapter YAML residue (same as CH01-B01 — global cleanup)
- **Priority:** MED
- **Perspective:** Publisher
- **Effort:** S
- **Location:** Ch_02_R_Basics.qmd → YAML front matter (search anchor: "fontsize: 11pt")
...
- **Approved:** [ X] — IMPLEMENTED 2026-08-12 (done here rather than deferred, since the chapter was already open and rendering; 21 chapters still remain for G01)
