# Chapter 14 — Statistical Control: What Are We Actually Removing? (Ch_15_Statistical_Control.qmd)
...
- **Effort:** S
- **Location:** Ch_15_Statistical_Control.qmd → "Statistical Control Is Not Experimental Control" (search anchor: "callout-danger")
...
- **Effort:** S
- **Location:** Ch_15_Statistical_Control.qmd → "How This Becomes the Multiple-Regression Slope" (search anchor: "This result is sometimes called the **Frisch–Waugh–Lovell theorem**")
...
- **Perspective:** Student
- **Effort:** S
- **Location:** Ch_15_Statistical_Control.qmd → "Four Questions Before You Escape" (search anchor: "### 1. Caffeine, Sleep, and Exam Scores")
