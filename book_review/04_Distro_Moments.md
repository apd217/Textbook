# Chapter 4 — Distributions and their Moments (Ch_04_Distributions.qmd)
...
- **Effort:** S
- **Location:** Ch_04_Distributions.qmd → income figure chunk (search anchor: "mean_income <- weighted.mean(")
...
- **Perspective:** Professor
- **Effort:** S
- **Location:** Ch_04_Distributions.qmd → "Step 1: Simulate the population distributions" (search anchor: "mutate(data = map2(n, mean,")
...
- **Perspective:** Student
- **Effort:** M
- **Location:** Ch_04_Distributions.qmd → "Moment 2: Spread" (search anchor: "we divide by $N - 1$ instead of $N$")
...
- **Perspective:** Student
- **Effort:** S
- **Location:** Ch_04_Distributions.qmd → "Finding Probability from Z-scores" (search anchor: "pnorm(2) - pnorm(1)")
...
- **Perspective:** Professor
- **Effort:** S
- **Location:** Ch_04_Distributions.qmd → "Step 2: Visualize the distributions" (search anchor: "aes(y = ..density..)")
...
- **Perspective:** Professor
- **Effort:** S
- **Location:** Ch_04_Distributions.qmd → "Step 4: Z-score to probability" (search anchor: "Z.Alex <- (10 - 12.75) / 4.87")
...
- **Perspective:** Professor
- **Effort:** S
- **Location:** Ch_04_Distributions.qmd → "Moments" (search anchor: "Four numbers capture the important features")
...
- **Effort:** S
- **Location:** Ch_04_Distributions.qmd → income chunk header (search anchor: "{r, width = 6.5, height = 3, echo=FALSE}") and "### Historical sidenote" (search anchor: "top marginal tax rate")
...
- **Perspective:** Publisher
- **Effort:** S
- **Location:** Ch_04_Distributions.qmd → income chunk (search anchor: "read_excel(\"hinc01.xlsx\"")
