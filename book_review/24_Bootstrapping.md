# Chapter 24 — Advanced: Bootstrapping, the Jackknife, and Resampling (Ch_36_Bootstrapping.qmd)
...
- **Effort:** S
- **Location:** Ch_36_Bootstrapping.qmd → "Bootstrapping a Regression Slope" (search anchor: "rnorm(90, 0, 3 + RegressionData$Sleep)")
...
- **Effort:** S
- **Location:** Ch_36_Bootstrapping.qmd → CI callout (search anchor: "442 first-year students, 34 master's students, and 118 researchers")
...
- **Perspective:** Publisher
- **Effort:** S
- **Location:** Ch_36_Bootstrapping.qmd → "The Short Story" (search anchor: "computation is not forgiveness.")
