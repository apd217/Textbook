# Chapter 3 — Probability: The Gods Are Fickle (Ch_03_Probability.qmd)
...
- **Effort:** M
- **Location:** Ch_03_Probability.qmd → setup chunk (search anchor: "echo = FALSE") and "Chance Is Fickle" section (search anchor: "set.seed(242343)")
...
- **Perspective:** Student
- **Effort:** S
- **Location:** Ch_03_Probability.qmd → "Chance Is Fickle, Not Obligated to Look Random" (search anchor: "Real coins have no taste.")
...
- **Effort:** M
- **Location:** Ch_03_Probability.qmd → "Advanced Section: Bayes, Base Rates, and a Scary Positive Test" (search anchor: "### Step 1: Who Has the Condition?")
...
- **Perspective:** Student
- **Effort:** S
- **Location:** Ch_03_Probability.qmd → "What This Has to Do with Statistics" (search anchor: "stop blaming divine intervention for bad design.")
...
- **Effort:** S
- **Location:** Ch_03_Probability.qmd → "What This Has to Do with Statistics" (search anchor: "possibly inside a dead salmon")
...
- **Approved:** [ x] — IMPLEMENTED 2026-08-12 (verified: `bennett2010` was already in references.bib AND already cited in Ch_20_Multiple_Comparisons, so the forward pointer resolves in both directions)

### [CH03-P02] "With replacement" is used before it's defined, and assumes deck-of-cards fluency
- **Priority:** LOW
- **Perspective:** Professor + Student
- **Effort:** S
- **Location:** Ch_03_Probability.qmd → "The multiplication rule" (search anchor: "Drawing two hearts **with replacement**")
