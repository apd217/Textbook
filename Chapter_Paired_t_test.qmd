...
## Power: How Many People Would You Need?
...
`r 2*n_independent` people the hard way against `r n_paired` the smart way. The paired design needs far fewer humans, because pairing removes the stable person-to-person differences from the denominator, exactly as the shoes-and-height section promised:
