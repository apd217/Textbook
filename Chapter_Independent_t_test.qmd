...
<!-- ALEX: two continuity things now that the opener points explicitly back at Ch5.
     (1) Ch5's CTA survey used a 1-5 scale; this chapter uses 1-7. Fine as a separate
     study, but a sharp reader who just came from Ch5 will notice.
     (2) On Ch5's 1-5 scale, 3 was exactly neutral and the finding was "roughly neutral."
     On this 1-7 scale, 4 is neutral, so a control mean of 3 is mild dislike. The story
     still works, but "classic Chicago baseline" now means something slightly grumpier
     than it did last chapter. Both are one-line fixes if they bother you. -->
...
We expect the control group to land near **3** (mild frustration, classic Chicago baseline) and the experimental group near **5** ("Wait... this works?").

I know those numbers because I am about to simulate them, which is the only situation in which I ever know the truth in advance.
