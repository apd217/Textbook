...
Two groups, thirty riders each. Those two `rnorm()` lines are the entire experiment. *I mean I could go out really get data, but again I would have to actually talk to people.* 
...
Individual commoners, I mean subway riders, all have very different experiences and attitudes toward the subway and toward the new schedule. Maybe some people like the chaos of the old system, or are freaked out by the clockwork timing of the new one. What are we, Switzerland with its adherence to precision, or Japan where you get a note to hand your boss if the train is a minute late?! Each person has their reasons, and we are not clinical psychologists (well, I am not, that is for sure) who need to unpack why their father yelling at them for stepping on their Legos at age 5 now shapes their perception of trains.

::: {.callout-note title="Who Are We Doing Research to Explain?"}
The goal of most experimental research is to understand how a treatment or manipulation would affect the "average" person. Remember that average person we talked about early on, when I showed you what a distribution was? The average person stands in for the boring, super average "every-person" (or the *Letzter Mensch*, as Nietzsche calls them). So we ask: how would the average person be affected by this treatment?

This is why it is so important to think about who the "average" person would be in our research. In this case it is not easy, cause I am randomly sampling subway riders. Do you think the time of day would matter? What if I went to get my data at rush hour instead of 3am on the Red Line? Or what if I only rode the Brown Line well above the Loop, in the more affluent areas? Never forget who our sample is and who the average represents. This is going to be important in limiting the scope of our results and how far they generalize.
:::
...
That is not a typo. Group 1 is a guess and wobbles. Group 2 is a guess and wobbles. When you subtract two wobbly numbers, the wobble does not politely cancel out, it piles up. You are now uncertain about where the first mean sits *and* uncertain about where the second one sits, and both of those doubts make the gap between them harder to trust. Uncertainty always accumulates. It never subtracts.
:::
...
So Welch's t-test corrects this problem by shrinking our estimate of the degrees of freedom. Remember that our df sets the critical values of the t-distribution. By shrinking our df, we push those critical values further out into the tails, so a result has to be more extreme before we are allowed to call it anything. Thus we make our test more conservative, harder to say something is there when it is not. Remember type I error.
...
Now let R do the same arithmetic. Here it is in **formula syntax**, `outcome ~ group`, which is what your lab uses and what every regression in Part 2 of the book will use:
...
<!-- ALEX: your original line said "if its between .01 and .001 you say p < .01" and I
     changed it, because that rule collides with the "report the exact p-value" advice in
     Ch6 and with this chapter's own APA paragraph, which prints an exact p unless it is
     below .001. If you do want the older bracketed style (p < .05, p < .01, p < .001),
     say so and I will make Ch6 and the APA paragraph agree with it instead. -->
:::
