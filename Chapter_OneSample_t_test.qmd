...
<!-- ALEX: CH06-P03 is the one item in this chapter you left unchecked, so I did not touch
     the two lines below. Flagging it anyway because it is the item I would most want a
     second look at: "the treatment has likely caused a difference" is a causal claim, and
     this design has no control group and no random assignment. Your own "Important Note"
     section above says exactly that. Also "(See Bayesian Statistics)" points at a chapter
     that does not exist in the active book. Both are one-line fixes if you want them. -->
