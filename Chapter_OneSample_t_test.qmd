...
To explain, let's use those very scientifically informed ghost hunting investigation TV shows which are so much fun to watch *(don't judge me)*. The short host, a bro whose pants are too tight, says to his tall goofy best friend, "The EMF (electromagnetic) meter is spiking and I feel a cold spot. Dude, I feel an *evil* presence which is giving me the chills." "Brooo," says the tall one, mocking his short buddy, "did we find the ghost of Ronald Fisher, that famous statistician who invented ANOVA? I bet he cannot rest cause people are trashing his equations." The short bro says, "You are right!", with all seriousness, ignoring the mocking tone, "let's check the spirit box." He pulls out the spirit box, which randomly scans the radio stations quickly, and they hear ...static... "Analysis"...static..."Variance"...static... The short bro is now terrified, and they run out convinced they found the ghost of Fisher.

What is wrong with our hosts? Damaged pre-frontal cortex? No, they are just normal people making normal people errors of logic. First, humans like to have reasons for everything. We want to have a *cause* for what we just experienced (see probability chapter). Second, it's impossible to prove that nothing is there. No matter how much we explain that there are no ghosts, how can you provide evidence against nothing? You cannot see one, you cannot touch one, so you assume the evidence given by the EMF meter, the cold spot, and the spirit box chatter is proof of ghosts. There are 1001 other reasons those things happened, but you theorized it was a ghost, you hypothesized it was Fisher, you heard Fisher's favorite words, so it must be Fisher! So they **accepted the alternative**. Actually, all we can really say is that there was an electromagnetic disturbance (maybe wires in the wall as he was walking past them), the cold spot (a draft in an old home), the chills (a psychosomatic response to his own fears), and the spirit box (pareidolia: humans making patterns out of randomness).
...
<!-- ALEX: this next sentence said the 9-person case gives a "much larger" standard error.
     It is the other way round: 9 Chicagoans give SE = 0.16, all 10 give SE = 0.91. Your
     inline code was already printing the smaller number right after the word "larger."
     I flipped the word. Everything downstream of here (the two curves, and your conclusion
     that one NYer makes Chicago pizza look average) was already correct. -->
