...
If the install fails, or your laptop is old enough to remember the Obama administration, use [Posit Cloud](https://posit.cloud/) instead. It runs RStudio in a browser, the free tier is enough for this course, and you can install locally later when you have an afternoon and a better mood.
...
That last pair matters sooner than you think. In a few chapters we start squaring how far each person sits from the mean, and half of those distances are negative. Write the parentheses.
...
There is also a search box in the Help pane for when you know what you want but not what it is called. Asking R beats guessing, and it beats trusting whatever a chatbot confidently invented about a function that does not exist.
