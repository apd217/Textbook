...
**That $h_{ii}$ is the same leverage from the hat matrix**, three sections ago. This is the point where the two halves of the chapter meet, and it explains something that otherwise looks like a coincidence. A high-leverage point pulls the line toward itself, which shrinks its own residual and makes it look better behaved than it is. HC2 and HC3 divide that shrinkage back out. HC3 divides by it twice, which is why it is the most conservative of the four and why it reacts hardest to influential cases.
